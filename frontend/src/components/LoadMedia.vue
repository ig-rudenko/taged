      ...
      <div class="file-upload">
        ...
        <div>
          <label class="py-3" for="file-input">
            <span class="cursor-pointer flex align-items-center mb-4">
        ...
        <div class="flex flex-wrap align-items-center">
          ...
          <div v-for="(file_obj, index) in files" class="m-2 w-15rem">
            <div class="flex align-items-end flex-column">
              <i @click="deleteFile(index)" class="pi pi-times border-round-2xl border-1 px-1 py-1" severity="danger" rounded outlined aria-label="Cancel" />
              <MediaPreview class="mr-3" :file="file_obj" />
            </div>
